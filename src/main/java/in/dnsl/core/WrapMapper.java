...
public class WrapMapper {
     ...
     * @return the wrapper
     */
    public static <E> Wrapper<E> customError(String message) {
        return wrap(
                Wrapper.CUSTOM_ERROR_CODE, StringUtils.isBlank(message) ? Wrapper.ERROR_MESSAGE : message);
    }
    /**
    ...
    public static <E> Wrapper<E> ok(String message, E o) {
        return new Wrapper<>(
                Wrapper.SUCCESS_CODE, StringUtils.isBlank(message) ? Wrapper.SUCCESS_MESSAGE : message, o);
    }
    ...
    public static <E> Wrapper<E> ok(String message) {
        return new Wrapper<>(
                Wrapper.SUCCESS_CODE, StringUtils.isBlank(message) ? Wrapper.SUCCESS_MESSAGE : message);
    }

    public static <E> Wrapper<E> result(Integer result) {
